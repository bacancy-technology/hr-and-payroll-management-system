...
export function getDemoCustomWorkflowBuilder(): CustomWorkflowBuilder {
  return {
    generatedAt: "2026-03-20T11:30:00.000Z",
    summary: {
      templates: 3,
      automatedSteps: 5,
    ...
    nodes: [
      {
        ...
        status: "Ready",
        detail: "Starts onboarding as soon as an employee record is created.",
      },
      {
        id: "workflow-node-onboarding-docs",
        templateId: "workflow-template-onboarding",
        ...
        status: "Watch",
        detail: "Offer, tax, and bank details remain visible until completion.",
      },
      {
        id: "workflow-node-onboarding-payroll",
        templateId: "workflow-template-onboarding",
        label: "If payroll setup pending",
        nodeType: "Condition",
        owner: "Payroll",
        executionMode: "Manual",
        status: "Watch",
        detail: "Routes the workflow to payroll-specific validation when setup is incomplete.",
      },
      {
        ...
        executionMode: "Automated",
        status: "Ready",
        detail: "Final status updates happen automatically when all dependent steps are complete.",
      },
      {
        ...
        executionMode: "Automated",
        status: "Ready",
        detail: "Launches the approval path as soon as the request is created.",
      },
      {
        id: "workflow-node-leave-coverage",
        templateId: "workflow-template-leave",
        label: "Validate coverage overlap",
        nodeType: "Condition",
        owner: "Manager",
        executionMode: "Assisted",
        status: "Watch",
        detail: "Flags payroll-close conflicts or team coverage gaps before approval.",
      },
      {
        ...
        executionMode: "Manual",
        status: "Watch",
        detail: "Pending and in-review requests keep this branch active.",
      },
      {
        ...
        executionMode: "Automated",
        status: "Ready",
        detail: "Receipts and metadata start the reimbursement workflow immediately.",
      },
      {
        id: "workflow-node-expense-policy",
        templateId: "workflow-template-expense",
        label: "Check policy rules",
        nodeType: "Condition",
        owner: "Finance",
        executionMode: "Automated",
        status: "Ready",
        detail: "Applies category and policy matching before finance review.",
      },
      {
        ...
        executionMode: "Assisted",
        status: "Ready",
        detail: "Only exceptions require manual attention before reimbursement is released.",
      },
    ],
  };
}
...
export function getDemoDashboardData(
  ...
  return {
    ...
    customWorkflowBuilder: getDemoCustomWorkflowBuilder(),
